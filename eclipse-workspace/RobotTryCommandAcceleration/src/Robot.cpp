...
void Robot::AutonomousInit(){
	...
	frc::SmartDashboard::PutBoolean(" ",switchside=="R");// && DriverStation::Alliance::kBlue==DriverStation.GetInstance().GetAlliance()));
	frc::SmartDashboard::PutBoolean("======-======",switchside=="L");
	frc::SmartDashboard::PutBoolean("   ",scaleside=="R");
	frc::SmartDashboard::PutBoolean("=====-=======",scaleside=="L");
	frc::SmartDashboard::PutBoolean("      ",switchside=="R");
	frc::SmartDashboard::PutBoolean("=======-=====",switchside=="L");
